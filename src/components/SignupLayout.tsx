  ...
  return (
    <div className="flex w-full min-h-screen bg-white">
      ...
      <div className="hidden lg:flex flex-col justify-center items-center flex-1 bg-stack-bg-brand-tertiary p-10 gap-10">
        <img
          src="https://api.builder.io/api/v1/image/assets/TEMP/45d39e9649be6291b969b418b4695ed23bf52ba0?width=800"
          alt="Becoming rich illustration representing financial success and wealth building"
